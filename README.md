...
Thank you for visiting my GitHub profile! If you have questions, feel free to contact me via email or LinkedIn.

### Projects
- LULC classification using random forest in Google Earth Engine (GEE)
- Land Surface Temperature (LST) estimation in GEE
- Change detection using GEE
...
### Education
- [Vidyasagar University](http://www.vidyasagar.ac.in/Default.aspx), Geoinformatics, M.Sc. student
- [Bankura Christian College](http://www.bankurachristiancollege.in/), Geography, B.Sc.
- Bankura Zilla School, Higher Secondary
